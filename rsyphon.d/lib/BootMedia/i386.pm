...
#use lib qw(/home/dannf/cvs/rsyphon.head/lib);
...
sub build_floppy_image {
	...
	File::Temp::tempfile("/tmp/rsyphon.tmp.XXXXX", CLEANUP => 1);
...
sub build_iso_image {
    ...
    my $isodir = File::Temp::tempdir("/tmp/rsyphon.tmp.XXXXX", 
				     CLEANUP => 1);
...
sub write_syslinux_conf {
    ...
    my $default_config = "/etc/rsyphon/pxelinux.cfg/syslinux.cfg";
